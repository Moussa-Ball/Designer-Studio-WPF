...
namespace Coder
{
    ...
    public class Application : Studio.Softer.Application
    {
        ...
        /// </summary>
        public override string FullName => "Coder Studio";

        /// <summary>
        /// The short name of this application.
        /// </summary>
        public override string ShortName => "Coder";
        ...
        /// </summary>
        public override string logFilePath => GetOrCreateFilePath(System.Environment.SpecialFolder.ApplicationData, FullName, "logging.log");
    }
}
